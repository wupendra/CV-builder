   ...
   <body itemscope="itemscope" itemtype="http://schema.org/Person">
      <div class="container-fluid">
         <div class="row main clearfix">
            <a class="js-floating-nav-trigger floating-nav-trigger" href="#"><i class="icon-bars"></i><span class="close-icon">&times;</span></a>
               ...
               <div class="card profile-card">
                  ...
                  <div class="contact-details clearfix">
                    ...
                    <div class="detail">
                      ...
                      <span class="info" itemprop="telephone">{{ $user->phone }}</span>
                    </div>
                    <div class="detail">
                      <span class="icon"><i class="icon fs-lg icon-mail"></i></span>
                      <span class="info"><a class="link-disguise" href="mailto:{{ $user->email }}" itemprop="email">{{ $user->email }}</a></span>
                    </div>
                    <div class="detail">
                           ...
                           <ul class="list-unstyled clear-margin">
                            @forelse($user->works as $work)
                              <li class="card card-nested clearfix">
                                 <div class="content">
                                    <p class="clear-margin relative"><strong>{{ $work->position }}</strong>,&nbsp;<a href="{{ $work->website }}" target="_blank">{{ $work->company }}</a></p>
                                    <p class="text-muted">
                                      <small>
                                    ...
                                    <div class="skill-info">
                                      <strong>{{ $skill->name }}</strong>
                                        <div class="space-top labels">
                                          @if(!empty($skill->keywords))@foreach($skill->keywords as $key)
                              ...
                              <ul class="list-unstyled clear-margin">
                                @forelse($user->educations as $education)
                                 <li class="card card-nested">
                                    <div class="content">
                                       <p class="clear-margin relative"><strong>{{ $education->area }}, {{ $education->study_type }},&nbsp;</strong>{{ $education->institution }}</p>
                                       <p class="text-muted"><small>{{ !empty($education->start_date)?$education->start_date->format('F Y'):'' }} - {{ !empty($education->end_date)?$education->end_date->format('jS F Y'):'Present' }}</small></p>
                                       <i>{{ $education->gpa }}</i>
                                       <div class="space-top labels">
                                          @if(!empty($education->courses)) @foreach($education->courses as $course)
                           ...
                           <div class="content">
                              <ul class="list-unstyled clear-margin">
                                @foreach($user->awards as $award)
                                 <li class="card card-nested">
                                    <div class="content">
                                       <p class="clear-margin" itemprop="award"><strong>{{$award->title}} </strong>{{ $award->awarder }}</p>
                                       <p class="text-muted"><small>Awarded on: {{ !empty($award->date)?$award->date->format('jS F Y'):'' }}<</small></p>
                           ...
                           <div class="content">
                              <ul class="list-unstyled clear-margin">
                                @foreach($user->publications as $publication)
                                 <li class="card card-nested">
                                    <div class="content">
                                       <p class="clear-margin"><strong><a href="{{ !empty($publication->website)?$publication->website:'javascript:void(0)' }}" target="_blank">{{ $publication->name }}</a>&nbsp;,&nbsp;</strong>{{ $publication->publisher }}</p>
                                       <p class="text-muted"><small>Published on: {{ !(empty($publication->release_date))?$publication->release_date->format('jS F Y'):'' }}</small></p>
                                       <div class="mop-wrapper">
      ...
      <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.6/js/bootstrap.min.js"></script><script>$(function () {
